...
const Event = ({Day, Month, EventName, Description}) => {
    ...
    <div className='min-h-[calc(100vh-)] w-full xs:w-11/12 sm:w-9/10 md:w-[85%] mx-auto cursor-pointer  skew-y-2 bg-gradient-to-r from-magenta to-[#5800FF] text-white duration-200'>
