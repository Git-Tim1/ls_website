  ...
  return (
    <div>
      ...
      <div className='w-full mt-16 relative'>
        <Link to="/jan"><PersonView name="Jan-Philipp Lenhardt"  twitter="https://twitter.com/jan" email="janphilipp@gmail.com" instagram="instagram.com/" role="Landesvorsitzender" img={"https://media.discordapp.net/attachments/1084451122296664075/1084451524509442159/image-removebg-preview_5_1.png?width=816&height=810"} /></Link>
